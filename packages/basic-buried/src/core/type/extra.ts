...
export type ExtraInfoCustomType = BuriedCustomModel & Record<string, any>
...
export type BuriedCustomModelValue<T> = T extends keyof BuriedCustomModel ? BuriedCustomModel[T] : any
...
export type SimpleExtraInfoCustomType = SimpleBuriedCustomModel & Record<string, any>
...
export type SimpleBuriedCustomModelValue<T> = T extends keyof SimpleExtraInfoCustomType ? SimpleExtraInfoCustomType[T] : any
